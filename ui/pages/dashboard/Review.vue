              ...
              >
                ...
                <div>
                  ...
                  <div class="d-flex mb-1 justify-center justify-md-start">
                    <v-icon size="15" class="me-2" color="white"
                    ...
                    <div class="mb-6">
                      ...
                      <v-row class="mb-2">
                        <v-col cols="6" lg="6">
                          <v-img
                            contain
                            :src="
                              require('~/assets/images/gallery/foodFive.png')
                            "
                          ></v-img>
                        </v-col>
                        <v-col cols="6" lg="6">
                          <v-img
                            contain
                            :src="
                              require('~/assets/images/gallery/foodSix.png')
                            "
                          ></v-img>
                        </v-col>
                      </v-row>
                      <div>
                        <span class="grey--text text--darken-1 text-14"
                          >4 Likes, 2 Comments</span
                        >
                        <div class="mt-4">
                          <v-btn
                      ...
                      <div class="mb-6">
                        ...
                        >
                          ...
                          elit. Varius massa id ut mattis. Facilisis vitae
