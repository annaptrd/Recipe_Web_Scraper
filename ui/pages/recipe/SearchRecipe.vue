  ...
  <div>
    <v-container>
      ...
      <v-row>
        ...
        <v-col cols="6" v-model="values.ingredients" lg="6" md="4" sm="6">
          <v-text-field label="Include ingredients" hide-details="auto" clearable></v-text-field>
        </v-col>
        <v-col cols="6" v-model="values.blacklisted_ingredients" lg="6" md="4" sm="6">
          <v-text-field label="Exclude ingredients" hide-details="auto" clearable></v-text-field>
        </v-col>
      </v-row>
